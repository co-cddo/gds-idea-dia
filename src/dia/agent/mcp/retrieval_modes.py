...
_MODE_DESCRIPTION = (
    ...
    "- metadata_filtered_contract_finder_department: Contract Finder contracts for a specific department (requires entity_name).\n"
    "- search_by_project: Find a specific project or contract by name in Contract Finder (requires entity_name).\n"
    "- department_all_sources: All documents for a department across Business Cases, SR Bids, and Contract Finder (requires entity_name).\n"
