...
class ProcessingLedger(Protocol):
    ...
    The ledger uses a composite key of source_name, document key, and version
    to determine whether a document needs processing. If any component changes,
    the document is considered unprocessed.
    ...
    def get_unprocessed(self, refs: list[DocumentReference], source_name: str) -> list[DocumentReference]:
        ...
        composite key (source_name + key + version).
        """
        ...
